...
public class KafkaConfig {
    @Bean
    KafkaTemplate<String, OrderEvent> kafkaTemplate(final KafkaProperties properties) {
    ...
    @Bean
    org.springframework.kafka.config.ConcurrentKafkaListenerContainerFactory<String, OrderEvent> kafkaListenerContainerFactory(final KafkaProperties properties) {
