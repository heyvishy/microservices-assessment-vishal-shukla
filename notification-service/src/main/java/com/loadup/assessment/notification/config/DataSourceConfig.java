...
import com.loadup.assessment.notification.config.TenantDatabaseProperties.TenantDataSourceProperties;
...
public class DataSourceConfig {
    ...
    public DataSourceConfig(@Value("${app.flyway-location:classpath:db/notification-migration}") final String migrationLocation) {
